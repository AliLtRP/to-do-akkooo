        ...
        <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <form className="relative z-10 bg-white p-6 rounded-lg shadow-lg max-w-sm w-full" onSubmit={addTask}>
                <div className="mb-5">
                    ...
                    <input type="text" name="title" className="border border-gray-300 p-2 rounded w-full" onChange={handleTask} />
                </div>
                <div className="mb-5">
                    <label htmlFor="description" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
                    <input type="text" name="description" className="border border-gray-300 p-2 rounded w-full" onChange={handleTask} />
                </div>
